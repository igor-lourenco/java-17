...
public class FormatandoHora {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Formatando LocalTime passando o DateTimeFormatter: " + hora.format(DateTimeFormatter.ISO_TIME));
        System.out.println(">>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>");


        formatter = DateTimeFormatter.ofLocalizedTime(FormatStyle.SHORT);
        System.out.println("\nFormatando LocalTime com enum FormatStyle SHORT na hora: " + formatter.format(hora));

        formatter = DateTimeFormatter.ofLocalizedTime(FormatStyle.MEDIUM);
        System.out.println("Formatando LocalTime com enum FormatStyle MEDIUM na hora: " + formatter.format(hora));
...
//      ========================================================================================================================
        ...
        System.out.println("Formatando LocalDateTime com enum FormatStyle MEDIUM na hora passando Locale: " + formatter.format(hora));
        System.out.println(">>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>");
